...
const createTodo = createAsyncThunk("todo/createTodo", (data) =>
  todoService.createTodo(data)
);

const toggleTodo = createAsyncThunk("todo/toggleTodo", ({ id, data }) =>
  todoService.updateTodo(id, data)
);

const updateTodo = createAsyncThunk("todo/updateTodo", ({ id, data }) =>
  todoService.updateTodo(id, data)
);

const deleteTodo = createAsyncThunk("todo/deleteTodo", (id) =>
